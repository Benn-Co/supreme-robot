...
function connects_datamyFunction(item, index) {
    ...
    var item_connect_status = _status.connect_status;
        ...
        if (item_connect_status == "unread") {
            var check_status = '<i class="fa fa-check-circle float-right is-info status div3" aria-hidden="true">' + item_connect_status + '</i>';

        } else {
            var check_status = '<i class="fa fa-check-circle float-right is-dark status div4" aria-hidden="true">' + item_connect_status + '</i>';
